# The GitLab Duo Agent Platform Challenge (the “Hackathon”) Official Rules
...
* **Submission Period:** February 9, 2026 (10:00 am Eastern Time) – March 25, 2026 (2:00 pm Eastern Time) (“Submission Period”).
* **Judging Period:** March 30, 2026 (10:00 am Eastern Time) – April 17, 2026 (5:00 pm Eastern Time) (“Judging Period”).
...
* **Sponsor:** GitLab Inc. 268 Bush Street #350, San Francisco, CA 94104-3503
...
Entrants may enter by visiting gitlab.devpost.com (“Hackathon Website”) and following the below steps:
...
3.  Entrants must request access to the GitLab AI Hackathon group which is where all Projects must be published. Access will be provided to individuals who are registered for the Hackathon, provide a valid GitLab username, meet the above eligibility requirements, and who describe a valid submission idea. In order to request access, you must complete this form: [https://forms.gle/EeCH2WWUewK3eGmVA](https://forms.gle/EeCH2WWUewK3eGmVA). The Administrator and Sponsor reserve the right to only provide access to individuals who demonstrated a valid submission idea and remove access at their own discretion. Please note that access can only be requested and used for the purpose of completing your project for the GitLab Duo Agent Platform Challenge.
...
* **What to Create:** Entrants must create a working AI agent or flow (each an “Agent”) built on the GitLab Duo Agent Platform that helps with the Software Development Lifecycle (SDLC). The agent must perform a specific action or workflow automation (not just a text-based chat) (each a “Project”).
* **Functionality:** The Project must be capable of being successfully installed and running consistently on the GitLab Duo Agent Platform and must function as depicted in the video and/or expressed in the text description.
* **Platforms:** A submitted Project must run on the GitLab Duo Agent Platform for which it is intended and which is specified in the Submission Requirements and must be published in the GitLab AI Hackathon group here: [https://gitlab.com/gitlab-ai-hackathon](https://gitlab.com/gitlab-ai-hackathon).
* **New & Existing:** Projects must be either newly created by the Entrant or, if the Entrant’s Project existed prior to the Hackathon Submission Period, must have been significantly updated after the start of the Hackathon Submission Period. To the extent to which a component of the Project uses existing content, Entrants should explain, to the satisfaction of the Judges, acting in their sole discretion, how their Project was significantly updated during the Submission Period.
...
* A Project built with GitLab Duo Agent Platform and meet the above Project Requirements.
* Provide a URL to the Project. All configuration YAML files included in the Submission must be the original work of the Entrant(s). The Project must contain all necessary source code, assets, and instructions required for the project to be functional. If a repository is submitted as part of a Project, the repository must be public and comply with the licensing requirements set forth in the Submission IP requirements below. The repository must include appropriate license notice file(s): an MIT License notice file for any original work created by the Entrant, and applicable license notices for any third-party open source components. The primary license should be detectable and visible at the top of the repository page (in the About section).
* Include a text description that should explain the features and functionality of your Project.
* Include a demonstration video of your Project. The video portion of the Submission should be less than three (3) minutes. Judges are not required to watch beyond three minutes. It should include footage that shows the Project functioning on the device for which it was built. It must clearly show the Project reacting to a trigger and performing an action. It must be uploaded to and made publicly visible on YouTube, Vimeo, Facebook Video, or Youku, and a link to the video must be provided on the submission form on the Hackathon Website. It must not include third-party trademarks, or copyrighted music or other material unless the Entrant has permission to use such material.
...
* **Technological Implementation:** Does the project demonstrate quality software development? Does the project leverage the GitLab Duo Agent Platform (Tools, Triggers, Context)? How is the quality of the code?
* **Design:** Is the user experience and design of the project well thought out? Is the Agent easy to install, configure, and interact with? Does the workflow make sense?
* **Potential Impact:** How big of an impact could the project have on the target community? Does it solve a real "AI Paradox" bottleneck (e.g., reducing manual toil in planning, security, or operations)?
...
All Submissions remain the intellectual property of the Individuals or Teams that developed them. By submitting an entry, Entrants agree to the following:

**License to Promote and Use.** Entrant hereby grants to Sponsor a perpetual, worldwide, non-exclusive, royalty-free license to use, reproduce, display, perform, modify, and distribute those portions of the Submission owned or created by the Entrant, and any materials submitted therewith for purposes of administering and promoting the Hackathon, and evaluating the Submission. With respect to third-party open source software included in the Submission, Sponsor's rights are limited to those granted under the applicable open source license. This grant includes the right to use any suggestions, ideas, enhancement requests, feedback, or other recommendations provided by the Entrant related to the Submission. Sponsor may use the Submission to develop, market, and commercialize products and services.
...
**Promotional Rights.** Entrants agree that the Sponsor and Devpost shall have the right to promote the Submission and use the name, likeness, voice and image of all individuals contributing to a Submission, in any materials promoting or publicizing the Hackathon and its results, during the Hackathon Period and for three years thereafter. Submission components may be displayed to the public. All materials and responses provided with a Submission may be viewed by the Sponsor, Devpost, and judges for screening and evaluation purposes.
...
| :--- | :--- | :--- | :--- |
| Grand Prize | $15,000 USD<br>1000 points for GitLab Swag* | 1 | All eligible submissions |
| Most Technically Impressive | $5000 USD<br>1000 points for GitLab Swag* | 1 | All eligible submissions |
| Most Impactful | $5000 USD<br>1000 points for GitLab Swag* | 1 | All eligible submissions |
| Easiest to Use | $5000 USD<br>1000 points for GitLab Swag* | 1 | All eligible submissions |
| Honorable Mention | $500 USD<br>320 points for GitLab Swag* | 5 | All eligible submissions |
| Sustainable Design Bonus | $500 USD<br>320 points to purchase Swag<br>(Awarded to the Projects with exceptional sustainability practices in their design, from model optimization techniques to energy-efficient architecture choices.) | 4 | All eligible submissions |
| Category Prizes | | | |
| Most Impactful on GitLab & Google - Grand Prize | $10,000 USD<br>500 points to purchase Swag | 1 | All eligible submissions using GitLab and Google Cloud. |
| Most impactful on GitLab & Google Runner Up | $3,500 USD<br>500 points to purchase Swag | 1 | All eligible submissions using GitLab and Google Cloud. |
| Most Impactful on GitLab & Anthropic- Grand Prize | $10,000 USD<br>500 points to purchase Swag | 1 | All eligible submissions using GitLab and Anthropic. |
| Most Impactful on GitLab & Anthropic- Runner Up | $3,500 USD<br>500 points to purchase Swag | 1 | All eligible submissions using GitLab and Anthropic. |
| Green Agent Prize | $3,000 USD<br>500 points to purchase Swag | 1 | All eligible submissions that advance sustainability in software development. |

*\*Points can be used towards GitLab Swag on the GitLab Contributor Rewards Store, located at: [https://rewards.gitlab.com/](https://rewards.gitlab.com/)*

**IMPORTANT NOTES ON MULTIPLE PRIZE ELIGIBILITY:**
* A project can win a maximum of one (1) Grand Prize and a maximum of one (1) Category Prize.
...
Any Personal Data (as defined in Sponsor’s Privacy Statement) collected through Entrant’s use of Gitlab.com to create a Submission will be further subject to the Sponsor’s Privacy Statement, which is available here: [https://about.gitlab.com/privacy/](https://about.gitlab.com/privacy/).
